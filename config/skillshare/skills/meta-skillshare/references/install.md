...
# Name with flat prefixes (recommended)
skillshare install anthropics/skills --name frontend-my-skill   # → skills/frontend-my-skill/
skillshare install user/repo --name tools-my-skill -p           # → .skillshare/skills/tools-my-skill/
...
skillshare uninstall --group frontend      # Remove all skills with frontend-* prefix
